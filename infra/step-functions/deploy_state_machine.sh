...
echo "  1. S3 버킷 생성: aws s3 mb s3://hezo-cfn-templates --region ap-northeast-2"
echo "  2. 템플릿 업로드: aws s3 cp infra/cloudformation/customer-infra.yaml s3://hezo-cfn-templates/"
echo "  3. SSM 등록:"
