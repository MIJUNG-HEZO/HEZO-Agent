...
| S3 | `dev-hezo-chat-transcripts` | 대화 transcript artifact 저장 |
| S3 | `dev-hezo-p2-markdowns` | P2 domain markdown artifact 저장 |
| S3 | `dev-hezo-p4-contracts` | Contract draft/final artifact 저장 |
...
| CloudWatch Logs | `/aws/bedrock-agentcore/hezo-chat-agent-dev` | AgentCore 실행 로그 |
...
HEZO_CHAT_TRANSCRIPTS_BUCKET=dev-hezo-chat-transcripts
HEZO_P2_MARKDOWNS_BUCKET=dev-hezo-p2-markdowns
HEZO_CONTRACTS_BUCKET=dev-hezo-p4-contracts
...
HEZO_AGENTCORE_LOG_GROUP=/aws/bedrock-agentcore/hezo-chat-agent-dev
```
...
4. S3 bucket 3개 생성 및 public access block, encryption, versioning 설정
...
```text
s3://dev-hezo-chat-transcripts/sessions/{session_id}/transcripts/{seq}.json
s3://dev-hezo-p2-markdowns/domains/{domain}/question_guides/{version}.md
s3://dev-hezo-p4-contracts/sites/{site_id}/contracts/draft/{version}.json
s3://dev-hezo-p4-contracts/sites/{site_id}/contract_final.json
s3://dev-hezo-chat-transcripts/sessions/{session_id}/guardrails/{target}/{created_at}.json
```
